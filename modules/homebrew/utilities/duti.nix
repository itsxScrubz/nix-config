...
let
    ...
    # Suppress errors for extensions macOS doesn't have a registered UTI for
    # (e.g., .nix, .tsx, .svelte, .zig). duti can't set handlers for dynamic
    # UTIs — those extensions are typically opened from a terminal or IDE anyway.
